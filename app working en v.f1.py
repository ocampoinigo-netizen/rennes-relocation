...
# ---- PLANNING ----
    ...
    st.markdown(
        '<div class="section-banner banner-blue">📝 Pre‑Departure Essentials</div>',
        unsafe_allow_html=True,
    )
    st.markdown(
        '<div class="section-banner banner-blue">🧭 Pre‑Departure Info Hub</div>',
        unsafe_allow_html=True,
    )
...
Rennes is the **capital of Brittany**, located in northwestern France. With a population of around **220,000**, it’s known for its **large student community**, welcoming atmosphere, and balance of culture and technology.  
- 🎓 **Education hub:** Two major universities and many engineering & business schools.  
- 🚄 **Connected:** 1h25 from Paris by TGV high‑speed train.  
- 🎭 **Culture:** Famous for music festivals, street art, and Breton heritage.  
- 🌦️ **Climate:** Mild oceanic climate – cool winters and moderate summers.
...
Rennes is small enough to get around easily but big enough to offer everything you need.
    ...
    with st.expander("🛂 Visa Process"):
        st.markdown(
            """
<div class="theme-box" style="padding: 8px; border-radius:8px;">
If you are a **non‑EU citizen**, you’ll likely need a **long‑stay visa (VLS‑TS)** for studies or work.

**Student visa process:**
1. Apply through the [Campus France](https://www.campusfrance.org/) platform (Études en France procedure).  
2. Once accepted by your university, book an appointment at your **nearest French consulate**.  
3. Prepare documents: acceptance letter, proof of resources (~€800/month), accommodation proof, passport, and photo.  
4. After arrival in France, validate your visa online within **3 months** at [administration-etrangers-en-france.interieur.gouv.fr](https://administration-etrangers-en-france.interieur.gouv.fr).

**Work or other visas** follow a similar process but require an employment contract or specific reason for stay.
</div>
            """,
            unsafe_allow_html=True,
        )
    ...
    with st.expander("🤝 Understanding the Guarantor System"):
        st.markdown(
            """
<div class="theme-box" style="padding: 8px; border-radius:8px;">
In France, landlords usually ask for a **guarantor (garant)** — someone who commits to paying your rent if you cannot.

Options:
- 👪 **Family or friend guarantor** living in France.  
- 💼 **VISALE guarantee:** A **free government service** that can act as your guarantor. Apply online at [visale.fr](https://www.visale.fr/).  
- 🏦 Some private rental insurance companies also offer paid guarantee options.
...
- 🏢 **Studios (T1)** – €400‑€600/month  
- 👥 **Shared flats (colocation)** – €350‑€500/month  
- 🏡 **1‑bedroom apartments (T2)** – €550‑€800/month  
- 🎓 **Student residences (CROUS/private)** – €250‑€450/month

**Documents you’ll need:**
- Passport or ID  
- Proof of enrollment or employment  
- Proof of income or guarantor  
- VISALE or guarantee letter  

💡 **Tip:** Start searching early (June–August) and beware of scams; always visit or verify the property before sending money.
</div>
            """,
            unsafe_allow_html=True,
        )
...
# ---- ARRIVED ----
    ...
    with tabs[0]:
        st.markdown(
            '<div class="section-banner banner-green">🌆 Explore Rennes</div>',
            unsafe_allow_html=True,
        )
        st.markdown(
            """
        ...
        st.markdown(
            ...
            <h3 style="font-family:'Segoe UI', Roboto, Helvetica, Arial, sans-serif; color:#00B4D8; margin-bottom:8px; text-align:center;">
                🔍 Looking for an activity or place to visit?
            </h3>
            <p style="text-align:center; color:var(--text-color); font-size:1.05em; margin-top:0;">
                Use the filters below to discover your favorite spots in Rennes.
            </p>
            """,
            unsafe_allow_html=True,
        )
...
"""
    ...
    with tabs[1]:
        st.markdown(
            '<div class="section-banner banner-pink">🏛️ Administrative Guides</div>',
            unsafe_allow_html=True,
        )
...
<div class="theme-box" style="font-family: Arial, sans-serif; line-height: 1.6; border-radius:8px; padding:8px;">
  ...
  <p>Good luck with your search and welcome to Rennes! 🦞</p>
                ...
                st.markdown(f'<div class="theme-box" style="border-radius:8px; padding:8px;">**{cat_desc}**</div>', unsafe_allow_html=True)
                ...
                if not cat_posts.empty:
                    for _, post in cat_posts.iterrows():
                        ...
                        if post_body:
                            st.markdown(
                                f'<div class="theme-box" style="border-radius:8px; padding:8px;">{post_body}</div>',
                                unsafe_allow_html=True,
                            )
                        else:
    ...
    with tabs[2]:
        st.markdown(
            '<div class="section-banner banner-blue">👥 Community</div>',
            unsafe_allow_html=True,
        )
